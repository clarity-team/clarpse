...
public class ComponentReferenceTest {
    ...
    public void testResolveTypesComplex() throws Exception {
        ...
        rawData.insertFile(new File("/github/com/main/person.go", code));
        rawData.insertFile(new File("/github/com/html/template/person.go", codeB));
        rawData.insertFile(new File("/github/com/text/template/person.go", codeC));
    ...
    public void testTwoGoStructsReferenceEachOther() throws Exception {
        ...
        final SourceFiles rawData = new SourceFiles(Lang.GOLANG);
        rawData.insertFile(new File("src/github/test/person.go", code));
        final ClarpseProject parseService = new ClarpseProject(rawData);
        final OOPSourceCodeModel generatedSourceModel = parseService.result();
    ...
    public void testParseGoStructImplementsInterface() throws Exception {
        ...
        final SourceFiles rawData = new SourceFiles(Lang.GOLANG);
        rawData.insertFile(new File("/src/main/person.go", codeA));
        rawData.insertFile(new File("/src/lol/github/aninterface.go", codeB));
        final ClarpseProject parseService = new ClarpseProject(rawData);
        final OOPSourceCodeModel generatedSourceModel = parseService.result();
    ...
    public void testParseGoStructImplementsInterfaceComplex() throws Exception {
        ...
        rawData.insertFile(new File("/src/main/person.go", codeA));
        rawData.insertFile(new File("/src/lol/github/aninterface.go", codeB));
        rawData.insertFile(new File("/src/lol/github/aSecondinterface.go", codeC));
    ...
    public void testPackageImportResolveFunction() throws Exception {
        ...
        final SourceFiles rawData = new SourceFiles(Lang.GOLANG);
        rawData.insertFile(new File("src/custom/package/http/person.go", codeB));
        rawData.insertFile(new File("/src/custom/main/person.go", code));
        final ClarpseProject parseService = new ClarpseProject(rawData);
        final OOPSourceCodeModel generatedSourceModel = parseService.result();
    ...
    public void testGoStructMethodTripleParamComponentReference() throws Exception {
        ...
        rawData.insertFile(new File("src/github/http/http.go", codeB));
        final ClarpseProject parseService = new ClarpseProject(rawData);
        final OOPSourceCodeModel generatedSourceModel = parseService.result();
    ...
    public void testGoStructMethodSingleParamUniqueNameComplex() throws Exception {
        ...
        final SourceFiles rawData = new SourceFiles(Lang.GOLANG);
        rawData.insertFile(new File("/src/test/main/cherry.go", code));
        rawData.insertFile(new File("/src/main/test.go", codeB));
        final ClarpseProject parseService = new ClarpseProject(rawData);
        final OOPSourceCodeModel generatedSourceModel = parseService.result();
    ...
    public void simpleGitHubPkgRef() throws Exception {
        ...
        final SourceFiles rawData = new SourceFiles(Lang.GOLANG);
        rawData.insertFile(new File("test.go", codeB));
        final ClarpseProject parseService = new ClarpseProject(rawData);
        final OOPSourceCodeModel generatedSourceModel = parseService.result();
