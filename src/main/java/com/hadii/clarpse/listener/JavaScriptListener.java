...
public class JavaScriptListener implements Callback {
    ...
    private boolean shouldTraverse(Node n, Node parent) throws Exception {
        ...
        if (n.isClass()) {
            ...
            OOPSourceModelConstants.ComponentType paramComponentType = OOPSourceModelConstants.ComponentType.METHOD_PARAMETER_COMPONENT;
            ...
            cmp = createComponent(OOPSourceModelConstants.ComponentType.FIELD, n);
    ...
    private String generateComponentName(final String identifier, OOPSourceModelConstants.ComponentType componentType) throws Exception {
